...
export const CHAMADOS: Chamado[] = [
  ...
  { id: 2, codigo: 'AS-502', cliente: 'Construtora Vega', projeto: 'PRJ-0043', assunto: 'Gaveteiro com corrediça travando', prioridade: 'alta', tecnico: 'Diego Faria', abertoEm: '2026-06-17T08:30:00', status: 'peca-solicitada', pecaSolicitada: 'Corrediça telescópica 450mm' },
...
export const GARANTIAS: Garantia[] = [
  ...
  { projeto: 'PRJ-0043', cliente: 'Construtora Vega', ambiente: 'Home office', inicio: '2026-06-12', fim: '2028-06-12' },
